...
public class CSP_BFSProblem implements IProblem<String>
{
	...
	public CSP_BFSProblem(Integer curTrHeight, int edg, int vert, Map<String, String> setE, Set<String> setV, Map<Map<String, String>, Double> w_d, Map<String, Integer> labelA)
	{
