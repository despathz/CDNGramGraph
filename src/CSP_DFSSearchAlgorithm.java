...
public class CSP_DFSSearchAlgorithm implements ISearchAlgorithm<String>
{
	int methodCost;
	
	public CSP_DFSSearchAlgorithm()
	{
		methodCost = 0;
	}
	...
	{
	        IProblemTree<String> ptMyTree = new CSP_DFSProblemTree(); // Initialize tree
