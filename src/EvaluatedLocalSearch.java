...
public class EvaluatedLocalSearch implements LocalSearchI
{
	...
	public EvaluatedLocalSearch (int edg, int vert, Map<String, String> setE, Set<String> setV, Map<Map<String, String>, Double> w_d, Map<String, Integer> labelA, int tot)  //constructor
	{ 
		edges = edg;
		vertices = vert;
		setEdges = setE;
	...
	public List<String> lsAlgorithm()
	{
		...
		while (true)
		{
			...
			methodCost++; //randomInitialize() method cost
			...
			while (!isSolution(arrLoc) && (stopping_criteria < 1000)) //the assignement is not a solution
			{
				...
				methodCost++; //randomSelect() method cost
